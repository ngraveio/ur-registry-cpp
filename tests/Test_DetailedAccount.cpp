...
void TestDetailedAccount::testDetailedAccountWithHDKey()
{
    ...
    HDKey hdkey0;
    hdkey0.setKeyData(convertToStdArrayKeyData(QByteArray::fromHex("021c0b479ecf6e67713ddf0c43b634592f51c037b6f951fb1dc6361a98b1e5735e")));    
    const DetailedAccount detailedAccount{hdkey0, {"1st tokenid str", "some tokenid str"}};
    const QByteArray expectedBytes = QByteArray::fromHex("A201D99D6FA1035821021C0B479ECF6E67713DDF0C43B634592F51C037B6F951FB1DC6361A98B1E5735E02826F31737420746F6B656E69642073747270736F6D6520746F6B656E696420737472");
    const QString expectedUR = "ur:detailed-account/oeadtantjloyaxhdclaocebdflnntkjtiojsfsurbnfxrpeehkdlgyrtemrpytgyzocaswencymkpavwjkhyaolfjlehjkjycxjyjljeihjtiniecxjkjyjpjojkjljnihcxjyjljeihjtiniecxjkjyjpylwltyqd";
...
void TestDetailedAccount::testDetailedAccountWithOutputDesc()
{
    ...
    hdkey0.setKeyData(convertToStdArrayKeyData(QByteArray::fromHex("021c0b479ecf6e67713ddf0c43b634592f51c037b6f951fb1dc6361a98b1e5735e")));    
    HDKey hdkey1;
    hdkey1.setKeyData(convertToStdArrayKeyData(QByteArray::fromHex("0397fcf2274abd243d42d42d3c248608c6d1935efca46138afef43af08e9712896")));
    ...
    const QByteArray expectedBytes = QByteArray::fromHex("");
    const QString expectedUR = "ur:detailed-";
...
void TestDetailedAccount::UaiExampleBtcTpubNativeSegwit()
{
    ...
    const QByteArray expectedBytes = QByteArray::fromHex("A101D99D74A2016877706B68284030290281D99D6FA3035821026FE2355745BB2DB3630BBC80EF5D58951C963C841F54170BA6E5C12BE7FC12A6045820CED155C72456255881793514EDC5BD9447E7F74ABB88C6D6B6480FD016EE8C85081AE9181CF3");
    const QString expectedUR = "ur:detailed-account/oyadtantjyoeadisktjojeisdefzdydtaolytantjlotaxhdclaojlvoechgferkdpqdiabdrflawshlhdmdcemtfnlrctghchbdolvwsednvdztbgolaahdcxtottgostdkhfdahdlykkecbbweskrymwflvdylgerkloswtbrpfdbsticmwylklpaycywlcscewfhtfghnjy";
...
void TestDetailedAccount::UaiExampleDogeXpubLegacy()
{
    ...
    const QByteArray expectedBytes = QByteArray::fromHex("A101D99D74A20167706B68284030290281D99D6FA503582103C95BDE557F5E9B971E57DC0EA83D5FEF45AED46379558DEEB18D1D7E4AE8FBDD0458208B2E94720DDAFE556DE20F50E584BBE1011ED5676B647515A369234330EF7CD006D99D70A10186182CF503F500F507D99D70A1018400F404F4081A89C8766D");
    const QString expectedUR = "ur:detailed-";
...
void TestDetailedAccount::UaiExampleEthUsdc()
{
    ...
    QByteArray expectedBytes = QByteArray::fromHex("");
    QString expectedUR = "ur:detailed-";
...
void TestDetailedAccount::UaiExampleEthRangeIndex()
{
    ...
    QByteArray expectedBytes = QByteArray::fromHex("A101D99D6FA50358210204FA032947600AAE94A889DFC31B5C96AFCB7F7E23A189114B71E0254C4B88B50458201D710954E58073F927F283C61BC1428AC30A3D86D04DACB3A78613401F78183906D99D70A10186182CF5183CF500F507D99D70A1018600F400F4820002F4081A68B6E8A8");
    QString expectedUR = "ur:detailed-account/oyadtantjlonaxhdclaoaazsaxdtflhnbkplmwpdldursrcwhhmtpesblbkbcnoyldbygrjsvtdagsgrloreaahdcxcajsasghvwlajkytdiwzlsswcwsefwlesrbkfslntigtpsqdoslnbwfzctkscsesamtantjooyadlncsdwykcsfnykaeykattantjooyadlnaewkaewklfaeaowkaycyisrpvspdfhykihga";
...
void TestDetailedAccount::UaiExampleEthPairIndexAndWildcardIndex()
{
    ...
    QByteArray expectedBytes = QByteArray::fromHex("A101D99D6FA50358210204FA032947600AAE94A889DFC31B5C96AFCB7F7E23A189114B71E0254C4B88B50458201D710954E58073F927F283C61BC1428AC30A3D86D04DACB3A78613401F78183906D99D70A10189182CF5183CF500F500F48400F401F507D99D70A1018401F480F4081A68B6E8A8");
    QString expectedUR = "ur:detailed-account/oyadtantjlonaxhdclaoaazsaxdtflhnbkplmwpdldursrcwhhmtpesblbkbcnoyldbygrjsvtdagsgrloreaahdcxcajsasghvwlajkytdiwzlsswcwsefwlesrbkfslntigtpsqdoslnbwfzctkscsesamtantjooyadldcsdwykcsfnykaeykaewklraewkadykattantjooyadlradwklawkaycyisrpvspdfzcmkorh";
...
void TestDetailedAccount::UaiExampleSolanaUsdc()
{
    ...
    QByteArray expectedBytes = QByteArray::fromHex("A201D99D6FA103582100954768223BB94015350462BADA20DAEED7E25C4777F997B56C027746E4F8AC670281782C45506A465764643541756671535371654D32714E31787A7962617043384734774547476B5A77795444743176");
    QString expectedUR = "ur:detailed-account/oeadtantjloyaxhdclaemdfliscpfrrhfzbzecaaidrdtncxtnwytsvohhflktytmsrejzaoktfgveyapsioaolyksdwfegdimfghgieieecfpkpiyjsgugujsihgteyjsglehksknkkidhsjofxetfleektfeflfljehtktkkghfyjyehkooemytasw";
...
void TestDetailedAccount::UaiExampleMultiversxUsdc()
{
    ...
    QByteArray expectedBytes = QByteArray::fromHex("A201D99D6FA2035821004137C16B966ABAC1DF4CB893AF421EA0BE61A52266AA7B3AA993900F7139640F06D99D70A1018A182CF51901FCF500F500F500F502816B555344432D633736663166");
    QString expectedUR = "ur:detailed-account/oeadtantjloeaxhdclaefpemsejemtimrdseurgsromupefwcknbrnhsoncpiypkkgftptmumhbsjsesiebsamtantjooyadlecsdwykcfadztykaeykaeykaeykaolyjegogufyfxdpiaemeniyehiyronnkiuy";
...
void TestDetailedAccount::UaiExampleLtubLegacy()
{
    ...
    QByteArray expectedBytes = QByteArray::fromHex("A101D99D74A20167706B68284030290281D99D6FA3035821029A4BB443B79E8D2F1440D87F593735AF394C9C8417B28DB29681DF463D30E6E10458201652CEFDB06935CFBC8765DD56287210301613CB4F90B356F6BBD9E7A6BAA846081AA1C973C5");
    QString expectedUR = "ur:detailed-account/oyadtantjyoeadiojojeisdefzdydtaolytantjlotaxhdclaonygrqzfxrlnnlgdlbbfztplbhkemecpeesgsnslrchprlgprmtlyurfgfsdyvavyaahdcxcmgmtozcpfinectkrfltihuthfdejpbedycmbwsbgwmhqdhfynrktavdolrdpdfgaycyoysojksketwzbwfp";
...
void TestDetailedAccount::UaiExampleBtcZpubNativeSegwit()
{
    ...
    QByteArray expectedBytes = QByteArray::fromHex("A101D99D74A2016877706B68284030290281D99D6FA3035821027601C36582260D43FF6469418045B735F76558454B877B383FB5E0D4057959BD0458203389E29E33E9A43EA55C16F958CF61B03E236DE145CCFA55CF8DB5CE72F3E84B081A0DE6223F");
    QString expectedUR = "ur:detailed-account/oyadtantjyoeadisktjojeisdefzdydtaolytantjlotaxhdclaokoadsrihlfdsbtfxzmieinfplaferlecylihhdfegrltkgetfhrevttyahkkhkryaahdcxeoldvonneowloxfmonhhcmythdtkhspffmcnjnvyfesfzsgotklgretojpwfvsgraycybtvacpfhbwfdeogl";
